    ...
    <tr><td align="center">
      <table role="presentation" width="100%" style="max-width:560px;background:#fff;border:1px solid #e9e9ef;border-radius:18px;overflow:hidden">
        <tr><td style="padding:32px 32px 8px">
          ...
          <h1 style="margin:14px 0 0;font-size:26px;line-height:1.2;letter-spacing:-.03em">Seu acesso está liberado${nome ? `, ${nome}` : ''}!</h1>
        ...
        <tr><td style="padding:24px 32px 8px">
          <a href="${url}" style="display:inline-block;background:#0a0a0b;color:#fff;text-decoration:none;font-weight:600;font-size:15px;padding:14px 26px;border-radius:999px">Abrir o acervo completo</a>
          <p style="margin:14px 0 0;font-size:12.5px;color:#8e8e98;word-break:break-all">${url}</p>
        </td></tr>
