...
export async function generateMetadata({ params }) {
  ...
  const description = `Multitracks (VS) de ${artist.name} com clique, guia e canais separados. Inclusos no pacote Trilha Viva com mais de 2.000 multitracks gospel.`
  return {
    title,
    description,
