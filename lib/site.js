export const site = {
  ...
  fullPrice: 899.0,
  currency: 'BRL',
  // ID do conjunto de dados (Pixel) "Trilha Viva" no Gerenciador de Eventos da
  // Meta, conta de anúncios 1880113489626210 (criado em 24/09/2026). Não é
  // segredo: vai no HTML de toda página. O token da Conversions API, sim, é
  // segredo e fica só no painel da Cloudflare (META_CAPI_TOKEN).
  metaPixelId: process.env.NEXT_PUBLIC_META_PIXEL_ID || '1442620711074370',
}
