export const site = {
  ...
  description:
    'Trilha Viva é o acervo com mais de 2.000 multitracks gospel (VS) para igrejas e bandas de louvor. Clique, guia e canais separados, em todos os tons, em um único pacote com acesso vitalício.',
